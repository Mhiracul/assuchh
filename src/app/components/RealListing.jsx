...
const RealListing = () => {
  return (
    <div className="bg-[#DBF0F8]  h-full w-full">
      <div className="container mx-auto w-full  md:py-20 py-10 md:px-40 px-10">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-2 gap-10 md:mt-20 mt-10 mx-auto">
